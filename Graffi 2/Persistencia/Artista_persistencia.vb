...
Public Class Artista_persistencia
    ...
    Public Sub Alta_Artista(artistaa As artista)
        Try
            ...
            cadenadeconexion = "INSERT INTO artista(correo_electronico_artista, nombre_artistico, password,nombre_de_usuario) values (@correo_electronico_artista, @nombre_artistico,@password, @nombre_de_usuario);"
            ...
            cmd.Parameters.Add("@password", NpgsqlTypes.NpgsqlDbType.Integer).Value = artistaa._password
            cmd.Parameters.Add("@nombre_de_usuario", NpgsqlTypes.NpgsqlDbType.Varchar, 50).Value = artistaa._username
